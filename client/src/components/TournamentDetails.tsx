    ...
    <section id="tournament" className="py-24 relative hero-ff-background">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background:
              'radial-gradient(circle at 30% 30%, rgba(255, 87, 34, 0.2) 0%, transparent 60%)',
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          >
            <h6 className="font-orbitron text-[#FF5722] text-sm uppercase tracking-widest">
              Tournament Details
            </h6>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          >
            <div className="bg-black/80 backdrop-blur-sm rounded-lg border border-[#00E5FF]/30 p-8 relative h-full">
              ...
              <p className="text-gray-300 text-center">
                Classic Bermuda map with standard competitive settings. Prove
                your skills in familiar territory with high-intensity combat
                zones.
              </p>

              {/* Combat zones list */}
              <div className="mt-4 bg-black/40 p-3 rounded border border-[#00E5FF]/20">
                <h5 className="text-[#00E5FF] text-xs font-orbitron mb-2 text-center">
                  FEATURED DROP ZONES
                </h5>
          ...
          >
            <div className="bg-black/80 backdrop-blur-sm rounded-lg border border-[#FF5722]/30 p-8 relative h-full">
              ...
              >
                <div className="w-20 h-20 mx-auto bg-[#FF5722]/10 rounded-full flex items-center justify-center relative overflow-hidden">
                  ...
                  <motion.div
                    ...
                    animate={{
                      border: [
                        '1px solid rgba(255, 87, 34, 0)',
                        '1px solid rgba(255, 87, 34, 0.7)',
                        '1px solid rgba(255, 87, 34, 0)',
                      ],
                      scale: [0.8, 1.1, 0.8],
                    }}
              ...
              <p className="text-gray-300 text-center">
                Every player for themselves. No teams, no help - just pure
                skill, strategy and survival. Last player standing wins it all.
              </p>
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-[#FF5722]">20-40 MINS</span>
                  </div>
                  <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
                    <motion.div
                      className="h-full bg-gradient-to-r from-[#FF5722] to-[#FF8A65]"
          ...
          >
            <div className="bg-black/80 backdrop-blur-sm rounded-lg border border-[#00E5FF]/30 p-8 relative h-full">
              ...
              <p className="text-gray-300 text-center mb-4">
                Exclusive in-game rewards, diamonds, cash prizes and recognition
                in the Sarth Esports community.
              </p>
        ...
        >
          <div className="ff-section-border bg-black/80 backdrop-blur-md rounded-lg p-8 relative overflow-hidden">
            ...
            <div className="text-center mb-10 relative">
              <h3
                className="ff-glitch-text font-audiowide text-3xl text-white relative inline-block"
                data-text="TOURNAMENT SCHEDULE"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="relative p-6 z-10">
                  ...
                  <h4 className="font-orbitron text-lg mb-3 text-[#FF5722]">
                    REGISTRATION
                  </h4>
              ...
              >
                <div className="relative p-6 z-10">
                  ...
                  <h4 className="font-orbitron text-lg mb-3 text-[#00E5FF]">
                    QUALIFIERS
                  </h4>
                  <p className="text-gray-300 mb-3 font-rajdhani">
                    April 05, 2025
              ...
              <ul className="space-y-3 text-sm">
                ...
                >
                  ...
                  <span className="text-gray-300">
                    Players must have a stable internet connection and the
                    latest version of Free Fire.
                  </span>
                </motion.li>
                ...
                >
                  ...
                  <span className="text-gray-300">
                    Any form of cheating will result in immediate
                    disqualification.
                  </span>
                </motion.li>
                ...
                >
                  ...
                  <span className="text-gray-300">
                    Players must join the tournament lobby 15 minutes before the
                    scheduled start.
                  </span>
                </motion.li>
